...
#define         CALIBARAION_SAMPLE_TIMES     150    //define how many samples you are going to take in the calibration phase
...
float           Ro           =  0.49;                 //Ro is initialized to 10 kilo ohms
